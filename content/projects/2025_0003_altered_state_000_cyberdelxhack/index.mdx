...
status: ready
summary: >-
  For the **Cyberdelic Hackathon** (Berlin, Nov 2025) I built a **Meta Quest**
  mixed-reality app that alters your vision from real-time sensor data. Here
  the signal came from a microphone and a biotron sensor on fruits and
  vegetables, but the idea generalizes to any sensor: EEG, pressure, heart
  rate.
by:
...
For the **Cyberdelic Hackathon** (Berlin, 8–9 Nov 2025), I built a **Meta Quest**
